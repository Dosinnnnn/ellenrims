                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            <li class="{{ Request::path() == 'home' ? 'aktif' : '' }}"><a
                                                    href="{{ route('home') }}">Home</a></li>
                                            {{-- <li class="{{Request::path()=='about-us' ? 'aktif' : ''}}"><a href="{{route('about-us')}}">About Us</a></li> --}}
                                            <li class="@if (Request::path() == 'product-grids' || Request::path() == 'product-lists') aktif @endif"><a
                                                    href="{{ route('product-grids') }}">Products</a><span
                                                    class="new">New</span></li>
                                            {{ Helper::getHeaderCategory() }}
                                            {{ Helper::getHeaderBrands() }}
                                            {{-- <li class="{{Request::path()=='blog' ? 'aktif' : ''}}"><a href="{{route('blog')}}">Blog</a></li>									 --}}

                                            {{-- <li class="{{Request::path()=='contact' ? 'aktif' : ''}}"><a href="{{route('contact')}}">Contact Us</a></li> --}}
                                        </ul>
                                    </div>
                                </div>
                            </nav>
