...
@section('title', 'ELLENRIMS || HOME PAGE')
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                @php
                                    $categories=DB::table('categories')->where('status','aktif')->where('is_parent',1)->get();
                                    // dd($categories);
                                @endphp
                                @if ($categories)
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                ...
                                                <div class="product-action-2">
                                                    <a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Masukkan ke keranjang</a>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="row">
                    @php
                        $product_lists=DB::table('products')->where('status','aktif')->orderBy('id','DESC')->limit(6)->get();
                    @endphp
                    @foreach ($product_lists as $product)
                        <div class="col-md-4">
                            <!-- Start Single List  -->
