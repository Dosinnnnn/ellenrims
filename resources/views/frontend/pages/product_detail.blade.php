...
@endsection
@section('title', 'ELLENRIMS || PRODUCT DETAIL')
                            ...
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    <p class="price"><span class="discount">Rp.
                                            {{ number_format($after_discount, 2) }}</span><s>Rp.
                                ...
                                <!-- Size -->
                                {{-- @if (isset($product_detail) && $product_detail->ukuranBan && $product_detail->ukuranBan->count() > 0)
												<div class="size mt-4">
													<h4>Ukuran Ban</h4>
													<ul class="ukuran">
														@foreach ($product_detail->ukuranBan as $ukuranBan)
															<li class="mr-2"><a href="#" class="one">{{ $ukuranBan->ukuran }}</a></li>
														@endforeach
													</ul>
												</div>
											@endif --}}
                                ...
                                <div class="product-buy">
                                    ...
                                    {{-- <p class="cat">
													...
													@else
														<!-- Handle kasus ketika cat_info bernilai null -->
													@endif
												</p> --}}
                                    ...
                                    <p class="entitas">
                                        @if ($product_detail->brand)
                                            <strong>Brand:</strong>
                                            <a href="{{ route('product-brand', $product_detail->brand->slug) }}">
                                                {{ $product_detail->brand->title }}
                                            </a>
                                        @elseif($product_detail->cat_info)
                                                ...
                                                <div class="col-12">
                                                        ...
                                                        <div class="review-inner">
                                                            ...
                                                            @else
                                                                <p class="text-center p-5">
                                                                    Kamu butuh <a href="{{ route('login.form') }}"
                                                                        style="color:rgb(54, 54, 204)">Login</a> atau <a
                                                                        style="color:blue"
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            ...
                                                            <span>Berdasarkan {{ $product_detail->getReview->count() }}
                                                                Komentar</span>
                                                        </div>
