...
@section('main-content')
    ...
    <tr>
        ...
        <td>
            ...
            <sub>
                {{ $sub_cat_info ? $sub_cat_info->title : '' }}
            </sub>
        </td>
        <td>{{ $product->is_featured == 1 ? 'Yes' : 'No' }}</td>
        <td>
            @forelse($product->ukuranBan as $ukuran)
            {{ $ukuran->ukuran }}
        @empty
            No Size
        @endforelse
        ...
        <td>{{ $brands ? ucfirst($brands->title) : '' }}</td>
                                    <td>
                                        @if($product->stock > 0)
                ...
                @else
                    <h6 class="text-center">Produk Tidak Ditemukan!!! Silakan buat Produk</h6>
                @endif
            </div>
        </div>
    </div>
