...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="cat_id">Kategori Velg <span class="text-danger">*</span></label>
          <select name="cat_id" id="cat_id" class="form-control">
              <option value="">--Pilih kategori Velg--</option>
        ...
        <div class="form-group">
          ...
          <select name="ukuran_ban_id[]" class="form-control selectpicker" multiple data-live-search="true" data-none-selected-text="Pilih Ukuran Ban">
    ...
    <div class="form-group">
      ...
      <input id="berat" type="number" name="berat" min="0" step="0.01" placeholder="Enter weight" value="{{ old('berat') }}" class="form-control">
      @error('berat')
      <span class="text-danger">{{ $message }}</span>
      @enderror
   </div>
        ...
        <div class="form-group">
          ...
          <input id="quantity" type="text" name="stock" placeholder="Masukkan Jumlah" value="{{ old('stock') }}" class="form-control">
          @error('stock')
          <span class="text-danger">{{ $message }}</span>
          @enderror
      </div>
...
<script>
    ...
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "Tulis deskripsi detailnya.....",
          tabsize: 2,
          height: 150
      });
    });
